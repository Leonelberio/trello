		...
		<Container>
			<SectionContainer>
				<SectionHeaderContainer>
					...
					<SectionTitle>Administrateurs du conseil</SectionTitle>
				</SectionHeaderContainer>
				{board.members
			...
			<SectionContainer>
				...
				<DescriptionSectionContainer ref={descriptionAreaRef}>
					<DescriptionInput
						...
						placeholder="Il est temps pour votre planche de briller ! Faites savoir aux gens à quoi sert ce tableau et ce qu'ils peuvent s'attendre à voir."
					/>
					{textareaFocus && (
						<BottomButtonGroup
							title='Save'
